...
export const FINANCE_AI_SKILLS: FinanceSkillDefinition[] = [
  ...
  { id: "bank-statement-reconciliation-audit", nameAr: "تسوية وتدقيق الحساب البنكي الشهري", nameEn: "Monthly Bank Reconciliation & Audit", category: "control", descriptionAr: "تحليل كشف البنك المعتمد، تفسير كل دخول وخروج وربطه بالطرف والمستند والحساب، إعداد التسوية البنكية، وكشف الفرق بين صافي الحركة النقدية والربح المحاسبي الشهري.", dependencies: ["smart-expense-coding", "accounts-receivable-ai", "accounts-payable-ai", "detect-financial-anomalies", "analyze-financial-reports", "financial-control-agent"], humanApprovalRequired: true, highImpactAction: true },
...
export const FINANCE_AI_PIPELINES = {
  ...
  bankReconciliation: ["bank-statement-reconciliation-audit", "smart-expense-coding", "accounts-receivable-ai", "accounts-payable-ai", "detect-financial-anomalies", "analyze-financial-reports", "financial-control-agent"] as FinanceSkillId[],
