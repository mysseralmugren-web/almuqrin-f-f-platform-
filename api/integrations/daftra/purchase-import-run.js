...
async function createDraftInvoice(d,supplierId){const body={PurchaseOrder:{supplier_id:Number(supplierId),currency_code:'SAR',date:d.date,no:d.no,draft:true},PurchaseOrderItem:[{item:d.item,description:d.description,unit_price:d.net,quantity:1,tax1:15}]};return req('/api2/purchase_invoices.json',{method:'POST',body:JSON.stringify(body)});}
