...
const tests = [
  ["01 skill count is exactly 15", () => must(manifest.skill_count === 15 && manifest.skills.length === 15, "FINANCE_SKILL_COUNT_INVALID")],
  ["02 skill ids are unique", () => must(new Set(manifest.skills).size === 15, "FINANCE_SKILL_DUPLICATE")],
